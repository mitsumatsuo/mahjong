...
export const matches: Match[] = [
  { id: 0, name: "🀙", users: ["渡辺", "藤田", "松尾", "中川"] },
  { id: 1, name: "🀚", users: ["藤田", "橋本", "林", "中山"] },
  { id: 2, name: "🀛", users: ["橋本", "松尾", "小林", "高須賀"] },
  { id: 3, name: "🀜", users: ["松尾", "林", "中川", "宮地"] },
  { id: 4, name: "🀝", users: ["林", "小林", "中山", "渡辺"] },
  { id: 5, name: "🀞", users: ["小林", "中川", "高須賀", "藤田"] },
  { id: 6, name: "🀟", users: ["中川", "中山", "宮地", "橋本"] },
  { id: 7, name: "🀠", users: ["中山", "高須賀", "渡辺", "松尾"] },
  { id: 8, name: "🀡", users: ["高須賀", "宮地", "藤田", "林"] },
  { id: 9, name: "🀃", users: ["宮地", "渡辺", "橋本", "小林"] },
];
